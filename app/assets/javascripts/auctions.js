  ...
  $.get("/auctions.json", function(data) {
      ...
      data.active_auctions.forEach(function(auction) {
        ...
        if(!panic_mode) {
          ...
          if(the_panel.length == 0) {
            ...
            the_panel.find('.buy-button').data('allowed', auction.bidding_allowed);
    ...
    if(panic_mode) {
      ...
      data.active_auctions.forEach(function(auction) {
          ...
          $('#active_auctions').append('<div class="panel panel-info" data-id="' + auction.id + '">\
            ...
            <div class="panel-body">\
              ...
              \
              <input type="number" name="amount" class="form-control" value="' + (auction.current_price + 10) + '" readonly><br>\
              \
